  ...
  return (
     <section className="py-8">  
      ...
      <div className="text-center">
        ...
        >
         <span className="font-serif text-[#2E6515] font-semibold"> Salón "Arcoiris CRUNVAQ"</span>
        </motion.p>
         <motion.p 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
         <span className="text-lg font-serif text-[#80603A] font-normal"> Recepción 7:00 pm</span>
         <br />
         <a
